<?php /* Smarty version Smarty-3.1.19, created on 2017-12-03 17:46:50
         compiled from "/var/www/html/modules/contentbox/views/templates/admin/_configure/helpers/form/form.tpl" */ ?>
<?php /*%%SmartyHeaderCode:12685647875a242a7a598785-86806344%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '4bfccc81fc6759ee470a37cd9023ef34df77a792' => 
    array (
      0 => '/var/www/html/modules/contentbox/views/templates/admin/_configure/helpers/form/form.tpl',
      1 => 1420241390,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '12685647875a242a7a598785-86806344',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5a242a7b1b1ef7_42410153',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5a242a7b1b1ef7_42410153')) {function content_5a242a7b1b1ef7_42410153($_smarty_tpl) {?><?php if (!is_callable('smarty_function_counter')) include '/var/www/html/tools/smarty/plugins/function.counter.php';
?>
...
" alt="contentBox" style="float:left;">
                ...
                <div class="col-md-8 top-module-description">
                    ...
                    <div class="top-module-my-name"><a href="http://contentbox.org/?v=<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['input']->value['moduleVersion'], ENT_QUOTES, 'UTF-8', true);?>
">contentBox <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['input']->value['moduleVersion'], ENT_QUOTES, 'UTF-8', true);?>
</a></div>
...
"
 ...
 $_from = $_smarty_tpl->tpl_vars['input']->value['languages']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['language']->key => $_smarty_tpl->tpl_vars['language']->value) {
$_smarty_tpl->tpl_vars['language']->_loop = true;
?>
                        <option id="id_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['language']->value['id_lang'], ENT_QUOTES, 'UTF-8', true);?>
" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['language']->value['id_lang'], ENT_QUOTES, 'UTF-8', true);?>
"
 ...
 $_from = $_smarty_tpl->tpl_vars['input']->value['files']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['file']->key => $_smarty_tpl->tpl_vars['file']->value) {
$_smarty_tpl->tpl_vars['file']->_loop = true;
 $_smarty_tpl->tpl_vars['pos']->value = $_smarty_tpl->tpl_vars['file']->key;
?>
                    <?php if ($_smarty_tpl->tpl_vars['file']->value['name']!='index.php') {?>
                        <div class="fileContainer" style="" rel="content/<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['file']->value['name'], ENT_QUOTES, 'UTF-8', true);?>
" data-filename="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['file']->value['name'], ENT_QUOTES, 'UTF-8', true);?>
" data-filepath="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['input']->value['path'], ENT_QUOTES, 'UTF-8', true);?>
">
                            <div class="fileUrl">
                                <img src="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['input']->value['path'], ENT_QUOTES, 'UTF-8', true);?>
img/url.png" alt="URL"/>
                            </div>
                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                    ...
                                    <td style="height:90px;" valign="middle">
                                        <img src="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['input']->value['path'], ENT_QUOTES, 'UTF-8', true);?>
content/<?php echo rawurlencode($_smarty_tpl->tpl_vars['file']->value['name']);?>
" style="max-width:100px; max-height:100px" />
                                    </td>
                                    <?php } else { ?>
                                    <td style="height:90px;" valign="middle">
                                        *.<?php echo rawurlencode($_smarty_tpl->tpl_vars['file']->value['extension']);?>

                                    </td>
                                    <?php }?>
                                </tr>
                            </table>
                            <div class="fileName"><?php echo rawurlencode($_smarty_tpl->tpl_vars['file']->value['name']);?>
</div>
                        </div>
...
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate('helpers/form/form_group.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0, '12685647875a242a7a598785-86806344');
content_5a242a7adf5688_37295833($_smarty_tpl);
...
<?php if ($_valid && !is_callable('content_5a242a7adf5688_37295833')) {function content_5a242a7adf5688_37295833($_smarty_tpl) {?>
